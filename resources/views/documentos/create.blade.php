                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('documentos.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="form-group">
                                <label for="numero_documento" class="form-label">Numero del documento<span
                                        class="small text
                                -danger">*</span></label>
                                <input type="text" id="numero_documento" name="numero_documento" class="form-control"
                                    placeholder="Numero del documento" value="{{ old('numero_documento') }}">
                            </div>

                            <div class="form-group">
                                <label for="fecha_registro" class="form-label">Fecha de registro<span
                                        class="small text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col text-center">
                                    <button type="submit" class="btn btn-primary"
                                        onclick="return confirm('Guardado correctamente')">Guardar</button>
                                </div>
                            </div>
                    </form>
                </div>
