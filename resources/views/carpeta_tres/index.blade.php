            ...
            <div class="row g-2 align-items-center">
                <div class="col text-left">
                    ...
                    <div class="page-pretitle">
                        Listado de contenido de la carpeta {{ $carpeta_dos->nombre }}
                    </div>
                    <h2 class="page-title">
                        Registro
                    </h2>
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('carpetados.index', ['carpeta_uno' => $carpeta_dos->carpeta_uno_id]) }}"
                            class="btn btn-primary">
                            <i class="fas fa-arrow-left"></i> Volver
                        </a>
                        @can('acciones-carpetas')
                            <a href="{{ route('carpetatres.create', ['carpeta_dos' => $carpeta_dos->id]) }}"
                                class="btn btn-warning">
                                <i class="fas fa-plus"></i> Crear Subcarpeta
                            </a>
                            <a href="{{ route('carpetatres.arch', ['carpeta_dos' => $carpeta_dos->id]) }}"
        ...
        <div class="container-xl">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <!-- Search form -->
                            <form method="GET" action="{{ route('carpetatres.index') }}" class="d-flex">
                                <input type="hidden" name="carpeta_dos" value="{{ $carpeta_dos->id }}">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($carpeta_tres as $contenido)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            @can('acciones-carpetas')
                                                                <form
                                                                    action="{{ route('carpetatres.destroy', $contenido->id) }}"
            ...
            <div class="row">
                @foreach ($carpeta_tres as $contenido)
                    @if (!$contenido->archivo)
                        @php
                            $numero_registros = $contenido->carpetaCuatro()->count();
                        @endphp
                        <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                            <a href="{{ route('carpetatres.show', $contenido->id) }}" class="text-decoration-none">
                                <div class="card-folder p-3 h-100">
                                    <div class="d-flex justify-content-between align-items-start">
                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            @can('acciones-carpetas')
                                                <form action="{{ route('carpetatres.destroy', $contenido->id) }}"
                                                    method="POST" style="display:inline-block;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-sm btn-danger"
