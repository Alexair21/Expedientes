    ...
    <div class="col-lg-8 order-lg-1">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Creación de Usuario</h6>
            </div>
            <div class="card-body">
                @if ($errors->any())
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                    ...
                                    <input type="text" id="name" class="form-control" name="name" placeholder="Nombre" value="{{ old('name') }}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                    <label class="form-control-label" for="last_name">Apellido<span class="small text-danger">*</span></label>
                                    <input type="text" id="last_name" class="form-control" name="last_name" placeholder="Apellido" value="{{ old('last_name') }}">
                                </div>
                            </div>
                        </div>
